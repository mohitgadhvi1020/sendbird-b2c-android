...
import com.sendbird.uikit.test.databinding.SbViewFormItemChipComponentBinding
...
internal class FormItemChipView @JvmOverloads internal constructor(
    ...
    private fun createChip(chipText: String, selectedItems: List<String>, isSubmitted: Boolean): Chip {
        ...
        return TextChip(ContextThemeWrapper(context, com.sendbird.uikit.test.R.style.Component_ChannelMessageInput)).apply {
            text = chipText
